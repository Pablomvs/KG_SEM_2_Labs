...
DXGI_FORMAT GBuffer::GetFormat(Slot slot) const { return kFormats[static_cast<UINT>(slot)]; }
UINT GBuffer::GetWidth()  const { return m_width; }
UINT GBuffer::GetHeight() const { return m_height; }
